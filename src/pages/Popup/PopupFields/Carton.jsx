...
const Carton = (
    { 
      Reminder, setReminder, carton, setCarton, pack, setPack, card, setCard, tablet, setTablet, Total_pieces, setTotal_pieces, weight, setWeight, price, setPrice, expiryDate, setExpiryDate
    }
  ) => {
